...
const EmployeeList = () => {
  ...
  const handleEdit = (id) => {
    console.log('Edit employee:', id); // à faire
    alert(`Édition employé ID: ${id} - en cours de développement`); // temporaire
  };

  const handleDelete = (id) => {
    console.log('Delete employee:', id); // à faire
    alert(`Suppression employé ID: ${id} - en cours de développement`); // temporaire
  };
